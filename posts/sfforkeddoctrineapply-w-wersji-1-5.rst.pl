...
**Ważne!**
 Przed aktualizacją do 1.5, należy najpierw zaktualizować do 1.4 i
uruchomić dołączonego w niej
taska \ **sfForkedDoctrineApply:upgrade-proiles**. W wersji 1.5 jest on
już niedostępny, a dodatkowo, nie ma już z czego przenosić.
