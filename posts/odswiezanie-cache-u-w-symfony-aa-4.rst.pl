...
to
symfony <http://www.symfony-project.org/gentle-introduction/1_4/en/12-Caching>`_.
 Postanowiłem trochę popracować nad cachem pod wpływem pewnej
korespondencji.
...
z wartością **'cache\_dir'** w następujący sposób:
 *cache\_dir + / + pattern + .cache*
 Natomiast normalnie w cachu plikowym, pomiędzy ścieżką do cachu, a
wartością parametru znajdują się jeszcze dwa poziomy:
 *serwer/all*
