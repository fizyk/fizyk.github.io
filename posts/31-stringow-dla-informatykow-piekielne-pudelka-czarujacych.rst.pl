...
.. link:
.. description: Tyle ciągów znaków do przetłumaczenia znalazłem w module sfApply. Generalnie procedura wydobycia ich jest niemal prosta, wystarczy wykonać polecenie:
